...
function _default(PDFJS) {
  ...
  function createLoadingTask(src, options) {
    ...
    if (typeof src === 'string') source = {
      ...
      data: src
    };else if (_typeof(src) === 'object' && src !== null) source = Object.assign({}, src);else throw new TypeError('invalid src type'); // source.verbosity = PDFJS.VerbosityLevel.INFOS;
    // source.pdfBug = true;
  ...
  function PDFJSWrapper(canvasElt, annotationLayerElt, emitEvent) {
    ...
    this.renderPage = function (rotate) {
      ...
      var linkService = new _pdf_link_service.PDFLinkService();
      ...
      pendingOperation = pendingOperation.then(function () {
        ...
        if (isPDFDocumentLoadingTask(src)) {
          ...
          loadingTask = createLoadingTask(src, {
            onPassword: function onPassword(updatePassword, reason) {
              var reasonStr;
